"""
Django settings for sistema_voto_ue_angamarca project.
...
ROOT_URLCONF = 'sistema_voto_ue_angamarca.urls'
...
WSGI_APPLICATION = 'sistema_voto_ue_angamarca.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'sistema_voto_ue_angamarca', 'static'),
